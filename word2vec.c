...
int main(int argc, char **argv) {
    ...
    if ((i = ArgPos((char *) "-debug", argc, argv)) > 0)debug_mode = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-binary", argc, argv)) > 0)binary = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-cbow", argc, argv)) > 0)cbow = atof(argv[i + 1]);
    if (cbow) alpha = 0.05;
    if ((i = ArgPos((char *) "-alpha", argc, argv)) > 0)alpha = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-output", argc, argv)) > 0)strcpy(output_file, argv[i + 1]);
    if ((i = ArgPos((char *) "-window", argc, argv)) > 0)window = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-sample", argc, argv)) > 0)sample = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-hs", argc, argv)) > 0)hs = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-negative", argc, argv)) > 0)negative = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-threads", argc, argv)) > 0)num_threads = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-iter", argc, argv)) > 0)iter = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-min-count", argc, argv)) > 0)min_count = atof(argv[i + 1]);
    if ((i = ArgPos((char *) "-classes", argc, argv)) > 0)classes = atof(argv[i + 1]);
